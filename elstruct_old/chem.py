def electron_count(labels, charge):
    ...
    :rtype: int
    """
    nuc_charge = sum(map(element_charge, labels))
    return nuc_charge - charge


def element_charge(label):
    ...
    :rtype: int
    """
    return _NUCLEAR_CHARGES[label.upper()]


# Private
_NUCLEAR_CHARGES = {'X':   0,
                    'H':   1,
                    'HE':  2,
                    'LI':  3,
                    'BE':  4,
