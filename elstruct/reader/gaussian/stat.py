"""
Library of functions to assess the job status of a Gaussian 09e job using the output file.
...
def complete_msg_reader(output_string):
    ...
    complete_msg_pattern = 'Normal termination of Gaussian 09'
    # might need a parameter for number of times since mult jobs can be run
