...
CWD=/blues/gpfs/home/kmoore/elstruct-interface/examples/runner/names/1_SP_IO
...
MOLPRO_OPTIONS="--nouse-logfile --no-xml-output -L $MOLPRO_LIB -d $TMPDIR -I $TMPDIR -W $TMPDIR -o $CWD/dog"
