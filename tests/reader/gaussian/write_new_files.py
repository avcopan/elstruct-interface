""" Script to generate new files from a simple RHF/UHF/ROHF/DFT files of Gaussian09e
"""
...
# Line to change
OLD_FILES = {
    'rhf' : ['# RHF HF/6-31G*', 'rhf.inp'],
    'uhf' : ['# UHF HF/6-31G*', 'uhf.inp'],
    'rohf' : ['# ROHF HF/6-31G*', 'rohf.inp']
}
