...
CWD=/blues/gpfs/home/kmoore/elstruct-interface/tests/reader/molpro/calcs
...
MOLPRO_OPTIONS="--nouse-logfile --no-xml-output -L $MOLPRO_LIB -d $SCRDIR -I $SCRDIR -W $SCRDIR -o $CWD/rohf-uccsd.out"

# Run the molpro executable
mpirun $MPI_OPTIONS $MOLPROEXE $MOLPRO_OPTIONS $CWD/rohf-uccsd.inp 
