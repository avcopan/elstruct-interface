...
cmd_line_parser.add_argument("program",help="Specify program you will be running (Supported: cfour2, g09e, molpro2015, mrcc2018, nwchem6, orca4)")
...
substituted_template = Template(filename="/lcrc/project/PACC/submission/templates-bebop/"+submit_options.program+".mako").render(**submit_options_dic)
